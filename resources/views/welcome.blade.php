  ...
  "password": "string"
      ...
      "message": "Địa chỉ đã được xóa thành công"
        ...
        <div class="section">
            ...
            <!-- List Provinces -->
            <div class="endpoint">
                <h3 onclick="toggleDetails(this)">1. List Provinces</h3>
                <div class="details">
                    <p><strong>Endpoint:</strong> <code>GET /provinces</code></p>
                    <p><strong>Description:</strong> Retrieve a list of all provinces.</p>
                    <h4>Response</h4>
                    <p class="success">Success (200):</p>
                    <pre>[
      {
      ...
      },
      {
        ...
        "name": "Ho Chi Minh"
            ...
            <div class="endpoint">
                <h3 onclick="toggleDetails(this)">2. List Districts by Province</h3>
                <div class="details">
                    <p><strong>Endpoint:</strong> <code>GET /districts/{provinceId}</code></p>
                    <p><strong>Description:</strong> Retrieve a list of districts based on the provided province ID.</p>
                    <h4>Response</h4>
                    <p class="success">Success (200):</p>
                    <pre>[
      {
      ...
      },
      {
        ...
        "province_id": 1
            ...
            <div class="endpoint">
                <h3 onclick="toggleDetails(this)">3. List Wards by District</h3>
                <div class="details">
                    <p><strong>Endpoint:</strong> <code>GET /wards/{districtId}</code></p>
                    <p><strong>Description:</strong> Retrieve a list of wards based on the provided district ID.</p>
                    <h4>Response</h4>
                    <p class="success">Success (200):</p>
                    <pre>[
      {
